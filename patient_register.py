...
class Register:
    ...
    def __init__(self):
        ...
        self.lblage = Label(self.root, text="Age:", font=("Times", 15, "bold"))
        self.lblage.place(x=30, y=70, width=70, height=30)
        self.enage = Entry(self.root, font=("Times", 15, "bold"))
        ...
        self.enweight = Entry(self.root, font=("Times", 15, "bold"))
        ...
        self.engender = Entry(self.root, font=("Times", 15, "bold"))
        self.engender.place(x=120, y=170, width=300, height=30)

        self.lbladdress = Label(
            self.root, text="Address:", font=("Times", 15, "bold"))
        ...
        self.lblmobile = Label(
            self.root, text="Phone NO.:", font=("Times", 13, "bold"))
        ...
        self.lbldisease = Label(
            self.root, text="Disease:", font=("Times", 15, "bold"))
        self.lbldisease.place(x=30, y=320, width=70, height=30)
        self.endisease = Entry(self.root, font=("Times", 15, "bold"))
        self.endisease.place(x=120, y=320, width=300, height=30)

        self.lblboodgrp = Label(
            self.root, text="B Grp:", font=("Times", 15, "bold"))
        self.lblboodgrp.place(x=30, y=370, width=70, height=30)
        self.enboodgrp = Entry(self.root, font=("Times", 15, "bold"))
